...
public class SimulationFrame extends JFrame {
    ...
    public SimulationFrame(SimulationEngine engine) {
        ...
        control.setPreferredSize(new Dimension(800, 420));
        control.setMinimumSize(new Dimension(0, 320));
        ...
        SwingUtilities.invokeLater(() -> mainSplit.setDividerLocation(0.45));
        ...
        summaryBtn.addActionListener(e ->
                new SimulationSummaryFramePreview(engine).setVisible(true)
        );
